...
const routes = [
    ...
    },
    {
        ...
        children: [
            {
                path: 'list',
                loadChildren: () => __webpack_require__.e(/*! import() | pages-buyer-list-buyer-list-module */ "pages-buyer-list-buyer-list-module").then(__webpack_require__.bind(null, /*! ./pages/buyer-list/buyer-list.module */ "qLCV")).then(m => m.BuyerListPageModule)
            },
            {
                path: 'list/:id',
                loadChildren: () => __webpack_require__.e(/*! import() | pages-buyer-list-details-buyer-list-details-module */ "pages-buyer-list-details-buyer-list-details-module").then(__webpack_require__.bind(null, /*! ./pages/buyer-list-details/buyer-list-details.module */ "s2pZ")).then(m => m.BuyerListDetailsPageModule)
            },
            {
                path: '',
                redirectTo: 'list',
