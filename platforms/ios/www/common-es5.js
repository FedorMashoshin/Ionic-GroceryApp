  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["common"], {
    ...
    function Gdn9(module, __webpack_exports__, __webpack_require__) {
      ...
      var ProductService = /*#__PURE__*/function () {
        function ProductService(angularFireStore, angularFireAuth, storage) {
        ...
        _createClass(ProductService, [{
          ...
          value: function addProduct(product) {
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
              ...
              var imageData, documentId, storageRef;
              return regeneratorRuntime.wrap(function _callee2$(_context2) {
                while (1) {
                  switch (_context2.prev = _context2.next) {
                    ...
                    case 2:
                      product.creator = _context2.sent.uid;
                      imageData = product.img;
                      delete product.image;
                      documentId = null;
                      storageRef = null;
                      return _context2.abrupt("return", this.angularFireStore.collection('products').add(product).then(function (ref) {
                        console.log('ref: ', ref);
                        documentId = ref.id;
          ...
          key: "getSellerProduct",
          value: function getSellerProduct() {
          ...
          value: function deleteProduct(id) {
            this.angularFireStore.doc("products/".concat(id))["delete"]();
            this.storage.ref("products/".concat(id))["delete"]().subscribe(function (res) {});
          }
        }]);
